 ...
 */
package org.eclipse.pass.deposit.integration.shared.graph;
...
public class SubmissionGraphTest {
    ...
    public void generic() {
        ...
        Grant grant = graphBuilder.addEntity(Grant.class)
                                  ...
                                  .add("coPis", SubmissionGraph.uriSupplier.get())
                                  .add("coPis", SubmissionGraph.uriSupplier.get())
                                  .build();
    ...
    public void graph() {
        ...
        graphBuilder.link(SubmissionGraph.LinkInstruction.entityHaving("locatorIds", "mpatton1"))
                    .to(SubmissionGraph.LinkInstruction.entityHaving("awardNumber", "123456"))
                    .as(SubmissionGraph.Rel.PI);
        ...
        Policy policy = graphBuilder.addEntity(Policy.class)
                                    ...
                                    .linkTo(SubmissionGraph.LinkInstruction.entityHaving("repositoryKey", "edu:jhu:repo:j10p"), "repositories")
                                    .linkFrom(SubmissionGraph.LinkInstruction.entityHaving("localKey", "edu.jhu"), "policy")
                                    .build();
        ...
        graphBuilder.link(SubmissionGraph.LinkInstruction.entityHaving("localKey", "edu.jhu:nih.gov"))
                    .to(grant)
        ...
        graphBuilder.link(directFunder)
                    .to(grant)
                    .as(SubmissionGraph.Rel.DIRECT_FUNDER);

        graphBuilder.link(SubmissionGraph.LinkInstruction.entityHaving("locatorIds", "emetsge1"))
                    .to(grant)
