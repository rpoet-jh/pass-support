...
public class ClasspathResourceTest {
    ...
    private static Logger LOG = LoggerFactory.getLogger(ClasspathResourceTest.class);
    ...
    @Test
    @Disabled("Fails, test remains as documentation")
    ...
    @Test
    @Disabled("Passes locally, but not portable.  Remains for documentation.")
    ...
    private static ClassPathResource asClasspathResource(String resource) {
        String resourcePath = ClasspathResourceTest.class.getPackage().getName()
                                                       .replace(".", "/") + resource;
    ...
    private static UrlResource asUrlResource(String resource) {
        String resourcePath = "/org/eclipse/pass/deposit/builder" + resource;
        URL u = ClasspathResourceTest.class.getResource(resourcePath);
