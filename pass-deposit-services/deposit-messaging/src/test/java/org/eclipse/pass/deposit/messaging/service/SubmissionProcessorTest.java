...
//        super.setUp();
//
//        underTest = new SubmissionProcessor(passClient, depositSubmissionModelBuilder, packagerRegistry,
...
//
//    @Test
//    public void criFuncCriticalSuccess() {
//        String submissionId = randomId();
//        Submission s = mock(Submission.class);
//        DepositSubmission ds = mock(DepositSubmission.class);
//
//        when(s.getId()).thenReturn(submissionId);
//        when(depositSubmissionModelBuilder.build(submissionId)).thenReturn(ds);
//
//        assertSame(ds, critical(depositSubmissionModelBuilder).apply(s));
//
...
//
//    @Test
//    public void criFuncCriticalFailsModelBuilderException() {
//        String submissionId = randomId();
//        Submission s = mock(Submission.class);
//
//        when(s.getId()).thenReturn(submissionId);
//        when(depositSubmissionModelBuilder.build(submissionId.toString())).thenThrow(RuntimeException.class);
//
