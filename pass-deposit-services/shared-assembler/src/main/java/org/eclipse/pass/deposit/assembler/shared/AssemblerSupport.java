...
public class AssemblerSupport {
     ...
     *     <dt>{@link MetadataBuilder#archive(PackageOptions.Archive.OPTS)}</dt>
     *     <dd>{@link PackageOptions.Archive.OPTS#NONE}</dd>
     ...
     *     <dd>A function of the {@link MetadataBuilder#archive(PackageOptions.Archive.OPTS) archive} and
